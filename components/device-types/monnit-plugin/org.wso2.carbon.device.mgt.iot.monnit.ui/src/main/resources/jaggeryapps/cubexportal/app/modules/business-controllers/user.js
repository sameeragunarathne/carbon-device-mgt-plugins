...
var userModule = function () {
    ...
    publicMethods.getUIPermissions = function () {
        ...
        if (publicMethods.isAuthorized("/permission/admin/cubexportal/sensor/add")) {
            permissions["ADD_SENSOR"] = true;
        }
        if (publicMethods.isAuthorized("/permission/admin/cubexportal/sensor/view")) {
            permissions["VIEW_SENSOR"] = true;
        }
        if (publicMethods.isAuthorized("/permission/admin/cubexportal/gateway/add")) {
            permissions["ADD_GATEWAY"] = true;
        }
        if (publicMethods.isAuthorized("/permission/admin/cubexportal/gateway/view")) {
            permissions["VIEW_GATEWAY"] = true;
        }
        if (publicMethods.isAuthorized("permission/admin/device-mgt/devices/owning-device/view")) {
